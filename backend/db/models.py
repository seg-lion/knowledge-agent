...
class Document(Base):
    ...
    source_type: Mapped[str] = mapped_column(String(50), nullable=False)  # html, markdown, pdf, text
...
class UserInterest(Base):
    ...
    memory_type: Mapped[str] = mapped_column(String(20), default="preference")  # factual, preference, derived
...
class AgentMessage(Base):
    ...
    from_agent: Mapped[str] = mapped_column(String(50), nullable=False)  # collector, curator, librarian, editor
    to_agent: Mapped[str] = mapped_column(String(50), nullable=False)
    msg_type: Mapped[str] = mapped_column(String(50), nullable=False)    # proposal, veto, question, response, adjustment, confirm
    content: Mapped[str] = mapped_column(Text, nullable=False)
